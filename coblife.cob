...
000285 01 WS-GEN-STR     PIC X(9).
000290 01 WS-GEN-PRETTY  PIC X(9) VALUE '0'.
000295 01 WS-TALLY       PIC 9(9).
...
000702     DISPLAY WS-GENERATION-MSG WITH NO ADVANCING.
000703*    See REMOVE-LEADING-ZEROS-PARA. This is why Larry Wall.
000704     IF WS-GENERATION = 0 THEN
000705       DISPLAY '0'
000706     ELSE
000707       PERFORM REMOVE-LEADING-ZEROS-PARA
000708       DISPLAY WS-GEN-PRETTY
000709     END-IF.
...
001400 REMOVE-LEADING-ZEROS-PARA.
001410* We are not in Perl any more, children
001415* From http://computer-programming-forum.com/48-cobol/c5865094d0e52641-2.htm
001416* A general solution for arbitrary variables still eludes me.
001417* NB - Fails on zero. Handle that separately.
001420     MOVE WS-GENERATION TO WS-GEN-STR.
001420     MOVE ZEROS TO WS-TALLY.
001430     INSPECT WS-GEN-STR TALLYING WS-TALLY FOR LEADING ZEROS.
001440     MOVE WS-GEN-STR(WS-TALLY + 1:) TO WS-GEN-PRETTY.
